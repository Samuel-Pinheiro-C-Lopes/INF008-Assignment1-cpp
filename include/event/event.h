...
private:
    ...
    std::unordered_map<int, std::shared_ptr<Registration<AttendeeType>>> guestsRegistrations;
...
public:
    ...
    /* adds a registration */
    virtual bool addAttendeeRegistration(const std::shared_ptr<Registration<AttendeeType>>& registration);
